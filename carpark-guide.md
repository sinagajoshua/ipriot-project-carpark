...
![img.png](img.png)![Image of a modern car park](images/new_car_park.png)
...
> Because the register method is part of the CarPark class, so its behavior should be checked there.
